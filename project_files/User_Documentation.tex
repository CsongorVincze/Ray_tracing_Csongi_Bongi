...
A CMD-be (gcc compiler telepítése, és a megfelelő mappa kíválasztása után) a következő parancsot kell futtatni.:
\texttt{gcc -o video\_render.exe video\_render.c vec\_3.c sphere.c hittable.c hit\_list.c render.c animation.c common.c color.c ray.c intervals.c -lm}
A program csak windowson működik jelenleg. Ezután futtani kell a \texttt{video\_render.exe} fájlt.
