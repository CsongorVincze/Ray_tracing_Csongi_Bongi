...
a szoftver összefűzi a képkockákat egy vidóvá, és ezt el is indítja.
...
A \texttt{video\_render.exe} futtatásakor a program felteszi a videó
elkészítéséhez szükéges kérdéseket. Ezekkel állítjuk be a szükséges paramétereket Ezek sorba:
\begin{enumerate}
